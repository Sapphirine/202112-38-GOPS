...
for state_code in state_codes:
    ...
    sum_in_state_same_year = 2 * state_df.groupby('Year')['Data_Value'].mean()[12:18] # from 2011-2015
...
np.save('coronary_validation_correlation_spearman', state_res_df.to_numpy().flatten())